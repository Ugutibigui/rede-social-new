...
function trocaFotoPerfil(){
    ...
    localFotoPublicar.innerHTML = `<img class="img-div-foto-barra-superior" src="${usuarioAtual[0].fotoUsuario}" alt="">`
}
trocaFotoPerfil()
function carregaNomePerfilPubFalso(){
    let nameLocal = document.getElementById("text-dentro-input-falso-content-pubs")
    nameLocal.innerText = `No que você está pensando hoje, ${usuarioAtual[0].apelido}?`
}
carregaNomePerfilPubFalso()
